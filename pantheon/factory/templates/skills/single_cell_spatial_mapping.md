...
name: Map single-cell data to spatial coordinates
description: "MOSCOT-based workflow for aligning single-cell assays with spatial transcriptomics, filtering features, solving optimal transport, and imputing missing genes or labels."
tags: ["single-cell", "spatial-omics", "mapping", "moscot"]
---
